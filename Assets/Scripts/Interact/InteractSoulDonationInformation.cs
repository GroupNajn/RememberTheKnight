...
public class InteractSoulDonationInformation : MonoBehaviour, IInteractable, IInteractableUIText
{
    ...
    public InteractableUIData GetUIData()
    {
        ...
        {
            UIData.InfoText = $"Souls until next \n Wands Card Unlock: {data.SoulsRemainingToNextUnlockWands}";
        ...
        {
            UIData.InfoText = $"Souls until next \n Cups Card Unlock: {data.SoulsRemainingsoulToNextUnlockCups}";
        ...
        {
            UIData.InfoText = $"Souls until next \n Pentacles Card Unlock: {data.SoulsRemainingToNextUnlockPentacles}";
        ...
        {
            UIData.InfoText = $"Souls until next \n Swords Card Unlock: {data.SoulsRemainingToNextUnlockSwords}";
